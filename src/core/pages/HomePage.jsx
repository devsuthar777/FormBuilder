...
const HomePage = () => {
  ...
  return (
    <div className='w-10/12 mx-auto mt-7'>
        ...
        <p className='mx-auto font-bold text-pure-greys-300 w-3/5 text-center'>Create your customised forms with FromBuilder. Flexible and easy to make your forms to get your required feedbacks.</p>
    </div>
  )
}
